...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
                                          KC_LGUI,   LT(2,KC_SPC),  LCTL_T(KC_BSPC),     RALT_T(KC_DEL),  LT(1,KC_ENT),  KC_G
                                      //`--------------------------'  `--------------------------'
  ...
  [_LOWER] = LAYOUT( \
  //,-----------------------------------------------------.                    ,---------------------------------------------
       KC_GRV,    KC_EXLM,    KC_AT,    KC_HASH,    KC_DLR,    KC_PERC,                         KC_CIRC,    KC_AMPR,    KC_AS
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
      KC_TAB, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL, KC_TILD,                      KC_SLSH, KC_LT,   KC_GT,KC_LCBR, KC_RCBR, KC_Q
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
      KC_LSPO, KC_1, KC_2, KC_3, KC_4, KC_5,                      KC_6, KC_7, KC_8, KC_9, KC_0, KC_RSPC,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
  ...
  [_RAISE] = LAYOUT( \
  //,-----------------------------------------------------.                    ,---------------------------------------------
       KC_ESC, LGUI(KC_GRV),   LCTL(KC_LALT), LGUI(KC_LALT),      KC_CIRC,    KC_AMPR,                      LGUI(KC_LBRC), LG
\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
      KC_LSPO, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), RESET,                      KC_NO, KC_NO, KC_NO, KC_NO, LGUI(K
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
                                          KC_LGUI,   KC_SPC,  LCTL_T(KC_BSPC),     RALT_T(KC_DEL),   KC_ENT, KC_GRV \
                                      //`--------------------------'  `--------------------------'
  )
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case RGBRST:
      ...
      #endif
cole@coletux:~/Documents/keyboards/qmk_master/qmk_firmware/keyboards/crkbd/keymaps/genissbro$ cat keymap.c
#include QMK_KEYBOARD_H
#ifdef PROTOCOL_LUFA
  #include "lufa.h"
  #include "split_util.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TAB, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL, KC_TILD,                      KC_SLSH, KC_LT,   KC_GT,KC_LCBR, KC_RCBR, KC_QUOT,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSPO, KC_1, KC_2, KC_3, KC_4, KC_5,                      KC_6, KC_7, KC_8, KC_9, KC_0, KC_RSPC,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,   KC_SPC,  LCTL_T(KC_BSPC),     RALT_T(KC_DEL),   KC_ENT, KC_GRV \
